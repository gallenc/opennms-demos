...
public class JestDemoApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		// Check an index
		System.out.println("// Check an index");
		...
		System.out.println("// Create an index with options");
		...
		System.out.println("// Create an alias, then remove it");
		...
		System.out.println(" // Index a document from String");
		...
		System.out.println("// Index a document from Map");
		...
		System.out.println("// Index a document from POJO");
		...
		// Read document by ID
		System.out.println("// Read document by ID");
		...
		jestClient.execute(
				new Bulk.Builder().defaultIndex("employees").addAction(new Index.Builder(employeeObject1).build())
		...
		jestClient.executeAsync(new Index.Builder(employeeObject3).build(), new JestResultHandler<JestResult>() {
			...
			public void completed(JestResult result) {
				System.out.println("// Async operations success -handle result");
			}

			@Override
			public void failed(Exception ex) {
				// handle exception
				System.out.println("// Async operations failed -handle exception " + ex.getMessage());
			}
		});
